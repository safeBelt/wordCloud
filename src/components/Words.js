...
const databaseURL = "https://word-cloud-47d53.firebaseio.com";
        ...
        return(
            <div>
                ...
                <Dialog open={this.state.dialog} onClose = {this.handleDialogToggle}>
                    ...
                    <DialogContent>
                        <TextField label="단어" type="text" name="word" value={this.state.word} onChange={this.handleValueChange}></TextField>
                        <TextField label="가중치" type="text" name="weight" value={this.state.weight} onChange={this.handleValueChange}></TextField>
                    </DialogContent>
                    <DialogActions>
